...
public class TeacherService {
    ...
    public Teacher saveteacher(Teacher teacher) {
        if (teacher.getSubjects() != null) {
            ...
            for (Address address : teacher.getAddress()){
    ...
    public Teacher updateTeacher(Long teacherId, Teacher updateTeacher) {
        ...
        if (updateTeacher.getAddress() != null) {
            existingTeacher.getAddress().clear();
            existingTeacher.getAddress().addAll(updateTeacher.getAddress());
            existingTeacher.getAddress().forEach(address -> address.setTeacher(existingTeacher));
        }
